...
#define MAX_PROBE_PACKETS 2500
	...
	//PLEX
	int vfr; /* Set to 1 if the frame rate is variable (otherwise constant) */
...
#define AVFMTCTX_TS_FORCE_PAT  0x0002 /**< used to tell the MPEG-TS encoder
                                         to retransmit PAT/PMT before the
                                         next packet */
