...
static void retransmit_si_info(AVFormatContext *s)
{
    ...
    if (++ts->pat_packet_count == ts->pat_packet_period || s->ctx_flags & AVFMTCTX_TS_FORCE_PAT) {
...
static int mpegts_write_packet(AVFormatContext *s, AVPacket *pkt)
{
    ...
    //fprintf(stderr, "writing pts=%"PRId64"  pts=%"PRId64"  dts=%"PRId64" delay=%"PRId64"\n", pts, pts-delay, dts, delay);
