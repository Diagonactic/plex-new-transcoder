...
static void register_all(void)
{
    ...
    REGISTER_DECODER(MP1_MEDIACODECNDK, mp1_mediacodecndk);
    REGISTER_DECODER(MP2_MEDIACODECNDK, mp2_mediacodecndk);
    REGISTER_DECODER(MP3_MEDIACODECNDK, mp3_mediacodecndk);
    ...
    REGISTER_DECODER(MPEG4_MEDIACODECNDK,mpeg4_mediacodecndk);
    REGISTER_DECODER(VC1_CUVID,         vc1_cuvid);
    REGISTER_DECODER(VC1_MEDIACODECNDK, vc1_mediacodecndk);
    REGISTER_DECODER(VP8_CUVID,         vp8_cuvid);
    REGISTER_DECODER(VP8_MEDIACODEC,    vp8_mediacodec);
    REGISTER_DECODER(VP8_MEDIACODECNDK, vp8_mediacodecndk);
    ...
    REGISTER_DECODER(VP9_MEDIACODECNDK, vp9_mediacodecndk);

    REGISTER_DECODER(FAKE_AVI,          fake_avi);
