...
static void vda_buffer_release(void *opaque, uint8_t *data)
{
    CVPixelBufferRef cv_buffer = (CVImageBufferRef)data;
    CVPixelBufferRelease(cv_buffer);
}

static int vda_videotoolbox_buffer_create(VTContext *vtctx, AVFrame *frame)
{
...
static int vda_h264_end_frame(AVCodecContext *avctx)
{
    ...
    return vda_videotoolbox_buffer_create(vda, frame);
}
