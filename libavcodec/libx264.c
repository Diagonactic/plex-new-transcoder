...
static av_cold int X264_init(AVCodecContext *avctx)
{
    ...
    // Profile is passed along as an integer.
    switch (avctx->profile)
    {
      case FF_PROFILE_H264_BASELINE: x4->profile = av_strdup("baseline"); break;
      case FF_PROFILE_H264_MAIN: x4->profile = av_strdup("main"); break;
      case FF_PROFILE_H264_HIGH: x4->profile = av_strdup("high"); break; 
    }
